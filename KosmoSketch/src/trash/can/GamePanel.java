...
public class GamePanel extends JPanel {
   ...
   public void initDisplay(){
      ...
      jp_user3  = new JPanel();
      jp_user4  = new JPanel();
      jp_user1S = new JPanel();
      jp_user2S = new JPanel();
      jp_user3S = new JPanel();
      jp_user4S = new JPanel();
...
//cW 추가하기
      ...
      jlb_modeP.setFont(new Font("휴먼모음T", Font.PLAIN, 40));
      jlb_modeE.setFont(new Font("휴먼모음T", Font.PLAIN, 40));
      jlb_cPick.setFont(new Font("휴먼모음T", Font.PLAIN, 40));
      jlb_thick.setFont(new Font("휴먼모음T", Font.PLAIN, 40));
      jtf_thick.setFont(new Font("휴먼모음T", Font.PLAIN, 40));
      jlb_eraseAll.setFont(new Font("휴먼모음T", Font.PLAIN, 40));
      ...
      jp_user1.setPreferredSize(new Dimension(395,150));
      ...
      jlb_nickName1.setPreferredSize(new Dimension(80,80));
      jlb_nickName1.setFont(new Font("휴먼모음T", Font.PLAIN, 30));
      jlb_nickName2.setPreferredSize(new Dimension(80,80));
      jlb_nickName2.setFont(new Font("휴먼모음T", Font.PLAIN, 30));
      jlb_nickName3.setPreferredSize(new Dimension(80,80));
      jlb_nickName3.setFont(new Font("휴먼모음T", Font.PLAIN, 30));
      jlb_nickName4.setPreferredSize(new Dimension(80,80));
      ...
      jp_user1.add(jp_user1S);
      jp_user2.add(jp_user1S);
      jp_user3.add(jp_user1S);
      jp_user4.add(jp_user1S);
