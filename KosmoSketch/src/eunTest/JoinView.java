...
public class JoinView extends JPanel {
	...
	JPasswordField	jpf_pw_confirm		= null;
	...
	public void initDisplay() {
		...
		jpf_pw = new JPasswordField(15);
		jpf_pw_confirm = new JPasswordField(15);
		jtf_nickname = new JTextField(15);
		jtf_email = new JTextField(15);
		jtf_code = new JTextField(15);
		JTextField[] jtf_arr = { jtf_id, jpf_pw, jpf_pw_confirm, jtf_nickname, jtf_email, jtf_code };

		jbtn_id = new JButton("중복확인");
		jbtn_id.addActionListener(clientView);
		transparent1 = new JButton();
		transparent2 = new JButton();
		jbtn_nickname = new JButton("중복확인");
		jbtn_nickname.addActionListener(clientView);
		jbtn_email = new JButton("인증번호 전송");
		jbtn_email.addActionListener(clientView);
		jbtn_code = new JButton("인증번호 확인");
		jbtn_code.addActionListener(clientView);
